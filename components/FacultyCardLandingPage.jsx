...
export default function FacultyCardLandingPage({
  ...
  return (
    ...
    >
      <div
        className={`rounded-lg sm:p-4 p-2 flex text-center flex-col items-center cursor-pointer transition-colors duration-200 h-full ${
          theme
            ? "bg-[#ececec] text-[#0a0a0a] border border-zinc-400 hover:bg-[#d5d5d5] hover:border-blue-700"
